...
import { CheckCircle, ExternalLink, Shield, Upload, FileText } from "lucide-react"
          ...
          {stage === "intro" && (
            <div className="space-y-6">
              <div className="flex items-center gap-4">
                <div className="w-16 h-16 bg-gray-900 rounded-xl flex items-center justify-center border border-gray-700">
                  <span className="text-2xl">🌐</span>
                </div>
                <div>
                  <h1 className="text-3xl font-bold text-white">Connect Netlify</h1>
                  <p className="text-gray-400">Authorize via Netlify</p>
                </div>
              </div>
                ...
                <CardContent className="p-6">
                  ...
                  <ol className="space-y-3 text-sm">
                    ...
                    <li className="flex gap-3">
                      ...
                      <span className="text-gray-300">Authorize Hoxi read-only access</span>
                    </li>
                    <li className="flex gap-3">
                    ...
                    <div className="flex gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-xs text-gray-400 mt-1">
                          We only request permission to read analytics; we never modify your site.
                        </p>
                      </div>
                    </div>
                  </div>
